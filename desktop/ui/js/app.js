...
import { registerRoutes, navigate } from "./router.js?v=3";
import { renderSidebarDataPanel } from "./sidebar.js?v=3";
import { renderDashboard, renderScannerSoon } from "./views/home.js?v=3";
